...
def start_scheduler():
    ...
    # KST timezone triggers at 07:00 AM every day
    # Note: Server timezone should ideally be set to Asia/Seoul or specify timezone in CronTrigger
    scheduler.add_job(
        run_news_pipeline,
    ...
    scheduler.start()
    print("Scheduler started. News pipeline will run daily at 07:00 KST.")
